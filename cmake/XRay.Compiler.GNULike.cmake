...
if (CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND NOT XRAY_USE_DEFAULT_CXX_LIB AND NOT EMSCRIPTEN)
    if (NOT XRAY_CXX_LIB)
...
elseif (EMSCRIPTEN)
    # Target flags come from XRay.Emscripten.cmake
else()
    add_compile_options(
        -mfpmath=sse
        -msse3
